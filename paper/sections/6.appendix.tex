...
the unmodified prediction, mark a region by hand or load WeDetect-Uni
proposals, choose which of the $24$ layers the bias acts on, and
...
$1{,}081.9$~s on an NVIDIA RTX PRO 6000 Blackwell. Mixed precision can change
nearest-neighbour identities when gallery similarities are nearly tied, so it
is used only for candidate screening. As a diagnostic, two
consecutive FP32 encodings of eight images within the confirmatory process were
