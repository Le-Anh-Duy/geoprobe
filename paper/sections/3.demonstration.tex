...
sensitivity to that evidence; a small one indicates a prediction that is stable
...
embeddings and cached proposals locally. Only basemap tiles and place names
come from public map services, and they are not part of model inference.

We bring the demonstration machine; the appendix states the setup
requirements in full. The implementation, the evaluation
scripts and the results reported here are available at
\url{https://github.com/Le-Anh-Duy/geoprobe}.
